...
#include "asv_simulator/PolyhedraBuoyancyDrag.hh"
#include "asv_simulator/ShapeVolume.hh"
...
GZ_ADD_PLUGIN_ALIAS(asv::PolyhedraBuoyancyDrag,
                    "asv::PolyhedraBuoyancyDrag")
